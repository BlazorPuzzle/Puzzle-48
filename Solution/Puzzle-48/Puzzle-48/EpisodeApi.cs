...
public static class EpisodeApi
{
	...
	internal static readonly Episode[] Episodes = [
...
public class EpisodeServerSideClient : IEpisodeClient
{
	public Task<Episode> GetEpisode(int id)
	{
		return Task.FromResult(EpisodeApi.Episodes.FirstOrDefault(e => e.Number == id));
	}

	public Task<Episode[]> GetEpisodes()
	{
		return Task.FromResult(EpisodeApi.Episodes);
	}
}
